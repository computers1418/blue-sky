...
class ChooseTest extends StatefulWidget {
  const ChooseTest({Key? key}) : super(key: key);
                    ...
                    child: Column(crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        ...
                        RichText(
                          ...
                          children: [
                            const TextSpan(
                              text: "You can select multiple tests and click "
                            ),
                            const TextSpan(
                              text: "DONE at bottom ",
                              style: TextStyle(
                          ...
                          child: Stack(
                            ...
                            children: [
                              ...
                              Positioned(
                                top: 23,
                                child: Image.asset(
                                  "lib/pages/choose_test/assets/${items[i]}.png",
                                  width: 30,
                                  color: selected == i
                                      ? HexColor("#FF8412")
                                      : Colors.black,
                                ...
                                child: Stack(
                                  ...
                                  children: [
                                    ...
                                    Positioned(
                                      top: 23,
                                      child: Image.asset(
                                        "lib/pages/choose_test/assets/${items[i + 1]}.png",
                                        width: 30,
                                        color: selected == i + 1
                                            ? HexColor("#FF8412")
                                            : Colors.black,
